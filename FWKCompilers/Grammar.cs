...
namespace Translator {
  ...
  public class Grammar: AGrammar {
    ...
    public Grammar(List<Symbol> T,List<Symbol> V,
                     List<Production> production,string S0)
        : base(T,V,S0) { Production.Count=0; this.P = production; }
    ...
    public bool isTerm(string t) {
      foreach (var ti in this.T) 
        if (t.Equals(ti.symbol)) return true;      
      return false;
    }
  } // end Grammar
}